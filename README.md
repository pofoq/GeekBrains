1. 	Проект "Temperature" выполняет метод "Main" из проекта "CurrentMonth" (задание 2, 5).

2.	Проект "CurrentMonth"

3. 	Проект "EvenNumber"

4. 	Проект "CheckView". Тут прям заморочился, применил знания из видео "ООП. Змейка". Долго не мог остановиться))

5.	Выполнил в проекте 1 "Temperature"

6.	Выполнил в проекте "EvenNumber", файл "OfficeHours"
