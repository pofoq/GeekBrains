...
namespace Lesson_04
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Parent of 75: {node.Parent.Value}");
            Console.WriteLine($"Expected: 50");
            node = tree.GetNodeByValue(65);
            Console.WriteLine($"Right Child of 65: {node.RightChild.Value}");
            Console.WriteLine($"Expected: 70");
            tree.RemoveItem(75);
            Console.WriteLine($"Remove 75");
            Console.WriteLine($"Right Child of 65: " + (node.RightChild is null ? "NULL" : node.RightChild.Value.ToString()));
            Console.WriteLine($"Expected: NULL");
            Console.WriteLine($"Root Node: {tree.GetRoot().Value}");
            Console.WriteLine($"Expected: 50");
            tree.RemoveItem(50);
            ...
            tree.AddItem(37);
            Console.WriteLine($"Add 37");
            tree.AddItem(33);
            Console.WriteLine($"Add 33");
            node = tree.GetNodeByValue(37);
            Console.WriteLine($"Parent of 37: {node.Parent.Value}");
            Console.WriteLine($"Expected: 35");
            node = tree.GetNodeByValue(33);
            Console.WriteLine($"Parent of 33: {node.Parent.Value}");
            Console.WriteLine($"Expected: 35");
